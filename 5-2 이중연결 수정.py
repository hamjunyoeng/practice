...
class List:
  def __init__(self):
    ...
    self.visitList.insert_after(self.visitList.head,'www.hufs.ac.kr')
    self.nowSite = 1 # 현재 방문 주소의 인덱스
    print(self.addrList.getData(self.nowSite))
  ...
  def history(self):
    ...
    for i in range(self.visitList.size,0,-1): # self.visitList의 끝에서 부터
